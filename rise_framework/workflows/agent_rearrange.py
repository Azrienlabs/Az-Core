"""
Agent Rearrange for RISE Framework
...
from rise_framework.exceptions import ValidationError, GraphCycleError
...
class AgentRearrange:
    ...
    Example:
        >>> from rise_framework.workflows import AgentRearrange
        >>> 
        >>> # Create agents
