"""
Agent Pattern Router for RISE Framework
...
reasoning agent patterns in the RISE framework.
...
from rise_framework.core.base import BaseAgent
...
class AgentPatternRouter:
    """
    A router for advanced agent patterns in the RISE framework.
...
def create_agent(
    ...
    **kwargs,
    ...
    Example:
        >>> from langchain_openai import ChatOpenAI
        >>> from rise_framework.agents.agent_pattern_router import create_agent
        >>> 
        >>> llm = ChatOpenAI(model="gpt-4o-mini")
