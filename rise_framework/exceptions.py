"""
Custom exceptions for the Rise Framework.
...
class RiseFrameworkException(Exception):
    """
    Base exception for all Rise Framework errors.
...
class ConfigurationError(RiseFrameworkException):
    """
...
class ValidationError(RiseFrameworkException):
    """
...
class LLMError(RiseFrameworkException):
    """
...
class NodeExecutionError(RiseFrameworkException):
    """
...
class ToolExecutionError(RiseFrameworkException):
    """
...
class StateError(RiseFrameworkException):
    """
...
class SupervisorError(RiseFrameworkException):
    """
...
class TeamError(RiseFrameworkException):
    """
...
class GraphError(RiseFrameworkException):
    """
...
class RLError(RiseFrameworkException):
    """
...
class AgentError(RiseFrameworkException):
    """
...
class TimeoutError(RiseFrameworkException):
    """
