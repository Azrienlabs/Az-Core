"""
Agent Pattern Router for Arc Framework
...
reasoning agent patterns in the Arc Framework.
...
from arc.core.base import BaseAgent
...
class AgentPatternRouter:
    """
    A router for advanced agent patterns in the Arc Framework.
...
def create_agent(
    ...
    **kwargs,
    ...
    Example:
        >>> from langchain_openai import ChatOpenAI
        >>> from arc.agents.agent_pattern_router import create_agent
        >>> 
        >>> llm = ChatOpenAI(model="gpt-4o-mini")
