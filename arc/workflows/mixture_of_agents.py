"""
Mixture of Agents (MoA) for Arc Framework
...
from arc.exceptions import ValidationError
...
class MixtureOfAgents:
    ...
    Example:
        >>> from arc.workflows import MixtureOfAgents
        >>> from arc.agents import ReactAgent
        >>> 
